/*
 * kernel/font.c — 8×8 bitmap glyph table for printable ASCII (0x20–0x7E).
 *
 * The bitmaps are derived from the classic IBM PC VGA 8×8 character ROM.
 * Each row byte has its MSB as the leftmost pixel column.
 *
 * Glyphs for control characters (0x00–0x1F) and DEL (0x7F) are all-zero
 * (blank).  The rendering code should substitute '?' for out-of-range input.
 *
 * Layout of font_glyphs[c]:
 *   [0] = top row of glyph
 *   [7] = bottom row of glyph
 */

#include "font.h"

const uint8_t font_glyphs[128][FONT_HEIGHT] = {
    ...
    [0x67] = {0x00,0x00,0x3E,0x66,0x66,0x3E,0x06,0x7C}, /* g */
    ...
    [0x79] = {0x00,0x00,0x66,0x66,0x66,0x3E,0x06,0x7C}, /* y */
    ...
    [0x7E] = {0x3E,0x63,0x00,0x00,0x00,0x00,0x00,0x00}, /* ~ */
